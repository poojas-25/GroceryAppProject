...
public class BaseClass {
	...
	/*
	 * @BeforeMethod public void initializeBrowser() { driver = new ChromeDriver();
	 * driver.get("https://groceryapp.uniqassosiates.com/admin/login"); //for
	 * getting the URL driver.manage().window().maximize(); }
	 */
